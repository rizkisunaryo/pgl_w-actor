 ...
 * {@link org.robovm.apple.uikit.UIViewController#viewDidAppear(boolean)} method. The screen name must be set for any tracking calls to be made.
 * 
 * By default, this will use {@link org.robovm.bindings.googleanalytics.GAI#getDefaultTracker()} for tracking calls, but one can override this by setting the tracker
 * property. */
@NativeClass
public class GAITrackedViewController extends UIViewController {

	/** The tracker on which view tracking calls are be made, or {@code null}, in which case {@link org.robovm.bindings.googleanalytics.GAI#getDefaultTracker()} will be
	 * used. */
	@Property
